    ...
    <div className="bg-gray-100 font-sans">
      ...
      <section className="container mx-auto mt-8 p-8 bg-white shadow-md">
        ...
        <div className=" grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 flex item-center justify-center">
          ...
          {/* Team Member 2 */}
          <div className="team-member">
          <h2 className="text-2xl font-bold mb-4 text-center">Developer</h2>
            <img
              src={team1}
              alt="Team Member 2"
              className="rounded-full mb-4"
            ...
            <h3 className="text-lg font-bold text-center">MERN Full Stack Web Developer</h3>
            <p className="text-gray-700 text-center">Graduate from Government college of Engineerring Amravati</p>
